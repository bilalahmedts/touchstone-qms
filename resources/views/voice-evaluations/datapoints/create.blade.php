...
@section('content')
    ...
    <div class="card">
        ...
        <form action="{{ route('voice-evaluations.datapoints.store', $category) }}" method="post" autocomplete="off">
            @csrf
            <div class="card-body">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="question" placeholder="Enter the Question related to Datapoint" required>
                </div>
                @error('question')
                    <div class="validate-error">{{ $message }}</div>
                @enderror
