...
@section('title', 'My Appeal Detail')


@section('content')

    <div class="back-area mb-3">
        <a href="{{ route('voice-evaluation-reviews.my-appeals') }}" class="btn btn-secondary btn-sm"><i class="fas fa-arrow-left mr-2"></i> Go Back</a>
    </div>
    ...
    <div class="search-area">
        <div class="row">
            ...
            <div class="col-md-6">
                <h4 class="mb-0">My Appeal Detail</h4>
            </div>
