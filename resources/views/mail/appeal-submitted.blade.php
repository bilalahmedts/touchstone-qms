...
{{ $audit->appeal->user->name ?? '' }} has submitted an appeal for re-evaluation.
...
@component('mail::button', ['url' => route('voice-audit-appeals.show', $audit) . '?accesskey=' . $notifiable->access_key])
Touchstone QMS
@endcomponent
