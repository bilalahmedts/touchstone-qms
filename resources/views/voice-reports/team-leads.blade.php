                    ...
                    @foreach ($user_evaluations as $item)
                        @php
                            ...
                            if(count($item->teamLeadVoiceAudits) > 0){
                                ...
                                $communication = $communication / count($item->teamLeadVoiceAudits);
                                $sales =  $sales / count($item->teamLeadVoiceAudits);
                                $compliance =  $compliance / count($item->teamLeadVoiceAudits);
                                $customer_service =  $customer_service / count($item->teamLeadVoiceAudits);
                                $product_presentation =  $product_presentation / count($item->teamLeadVoiceAudits);
                        ...
                        <tr>
                            ...
                            <td class="action">
                                <a href="{{ route('voice-audits.index', 1) }}?search=1&record_id=&user_id=&associate_id=-1&campaign_id={{ $item->campaign_id }}&outcome=&from_date={{ $from_date }}&to_date={{ $to_date }}&from_time={{ $from_time }}&to_time={{ $to_time }}&review=" class="btn btn-success btn-sm" target="_blank"><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                    @endforeach
                @else
